...
export class PesquisadorService {
  ...
  private readonly API = 'http://localhost:8080/senac-20241-backend-exemplos/rest/pessoa';
  ...
  public consultarPessoasPorId(id: number):Observable<Pessoa> {
    return this.httpCliente.get<Pessoa>(this.API + '/' + id);
  }
  public consultarPesquisador():Observable<Array<Pessoa>> {
